...
label1=tk.Label(window,text="CALCULATOR",relief=RIDGE,borderwidth=9,width=39,fg="black",bg="#db4dff")
label1.config(font=('Courier New', 13))
label1.place(x=0,y=0)
# Last line Label
label1=tk.Label(window,text="~ Modified by Mythilly ",relief=RIDGE,borderwidth=5,width=49,fg="black",bg="#d147a3")
label1.config(font=('Courier New', 10))
label1.place(x=0,y=582)

# First Entry Box
text1 = tk.Entry(master=window, width=27,relief=SUNKEN,borderwidth=16,bg="#b35900")
...
def website():
    ...
    #webbrowser.get(path1).open('vashishthahari.weebly.com')
...
# All the BUTTONS of CALCULATOR
   # Top 5 buttons
but26 = tk.Button(frame1, text="Website",width=8,height=1,borderwidth=5, relief=tk.RAISED, fg="black", bg="#8585ad",command=website)
but26.config(font=('Arial bold',8))
but26.grid(row = 0, column = 0,padx=4)
but27 = tk.Button(frame1, text="Rate Us",width=8,height=1,borderwidth=5, relief=tk.RAISED, fg="black", bg="#8585ad",command=rating)
but27.config(font=('Arial bold',8))
but27.grid(row = 0, column = 1,padx=5)
but28 = tk.Button(frame1, text="Reset",width=8,height=1,borderwidth=5, relief=tk.RAISED, fg="black", bg="#8585ad",command=reset)
but28.config(font=('Arial bold',8))
but28.grid(row = 0, column = 2,padx=5)
but29 = tk.Button(frame1, text="History(H)",width=8,height=1,borderwidth=5, relief=tk.RAISED, fg="black", bg="#8585ad",command=history)
but29.config(font=('Arial bold', 8))
but29.grid(row = 0, column = 3,padx=5)
but30 = tk.Button(frame1, text="Close(X)",width=8,height=1,borderwidth=5, relief=tk.RAISED, fg="black", bg="#8585ad",command=close)
but30.config(font=('Arial bold', 8))
but30.grid(row = 0, column = 4,padx=5)

    # All the calculator button
#ROW 1
but1 = tk.Button(frame, text="AC",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#ccff99",command=delall)
but1.config(font=('Arial bold', 20))
but1.grid(row = 0, column = 0)

but2 = tk.Button(frame, text="C",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#ccff99",command=clr1)
but2.config(font=('Arial bold', 20))
but2.grid(row = 0, column = 1)

but3 = tk.Button(frame, text="%",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#ccff99")
but3.config(font=('Arial bold', 20))
but3.grid(row = 0, column = 2)

but4 = tk.Button(frame, text="/", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="black", bg="#00e673",command=bt4)
but4.config(font=('Arial bold', 20))
but4.grid(row = 0, column = 3)

but5 = tk.Button(frame, text="(", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="black", bg="#ffb84d",command=bt5)
but5.config(font=('Arial bold', 20))
but5.grid(row = 0, column = 4)

#ROW 2
but6 = tk.Button(frame, text="7",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#66ff66",command=bt6)
but6.config(font=('Arial bold', 20))
but6.grid(row = 1, column = 0)

but7 = tk.Button(frame, text="8",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#66ff66",command=bt7)
but7.config(font=('Arial bold', 20))
but7.grid(row = 1, column = 1)

but8 = tk.Button(frame, text="9",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#66ff66",command=bt8)
but8.config(font=('Arial bold', 20))
but8.grid(row = 1, column = 2)

but9 = tk.Button(frame, text="*", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="black", bg="#00e673",command=bt9)
but9.config(font=('Arial bold', 20))
but9.grid(row = 1, column = 3)

but10 = tk.Button(frame, text=")", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="black", bg="#ffb84d",command=bt10)
but10.config(font=('Arial bold', 20))
but10.grid(row = 1, column = 4)

#ROW 3
but11 = tk.Button(frame, text="4",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#66ff66",command=bt11)
but11.config(font=('Arial bold', 20))
but11.grid(row = 2, column = 0)

but12 = tk.Button(frame, text="5",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#66ff66",command=bt12)
but12.config(font=('Arial bold', 20))
but12.grid(row = 2, column = 1)

but13 = tk.Button(frame, text="6",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#66ff66",command=bt13)
but13.config(font=('Arial bold', 20))
but13.grid(row = 2, column = 2)

but14 = tk.Button(frame, text="-", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="black", bg="#00e673",command=bt14)
but14.config(font=('Arial bold', 20))
but14.grid(row = 2, column = 3)

but15 = tk.Button(frame, text="√", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="black", bg="#ffb84d",command=bt15)
but15.config(font=('Arial bold', 20))
but15.grid(row = 2, column = 4)

#ROW 4
but16 = tk.Button(frame, text="1",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#66ff66",command=bt16)
but16.config(font=('Arial bold', 20))
but16.grid(row = 3, column = 0)

but17 = tk.Button(frame, text="2",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#66ff66",command=bt17)
but17.config(font=('Arial bold', 20))
but17.grid(row = 3, column = 1)

but18 = tk.Button(frame, text="3",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#66ff66",command=bt18)
but18.config(font=('Arial bold', 20))
but18.grid(row = 3, column = 2)

but19 = tk.Button(frame, text="+", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="black", bg="#00e673",command=bt19)
but19.config(font=('Arial bold', 20))
but19.grid(row = 3, column = 3)

but20 = tk.Button(frame, text="^", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="black", bg="#ffb84d",command=bt20)
but20.config(font=('Arial bold', 20))
but20.grid(row = 3, column = 4)

#ROW 5
but21 = tk.Button(frame, text="00",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#66ff66",command=bt21)
but21.config(font=('Arial bold', 20))
but21.grid(row = 4, column = 0)

but22 = tk.Button(frame, text="0",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#66ff66",command=bt22)
but22.config(font=('Arial bold', 20))
but22.grid(row = 4, column = 1)

but23 = tk.Button(frame, text=".",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="black", bg="#66ff66",command=bt23)
but23.config(font=('Arial bold', 20))
but23.grid(row = 4, column = 2)

but24 = tk.Button(window, text="=", width=8,height= 0,borderwidth=12,relief=tk.RAISED, fg="black", bg="#ff4000",command=result)
